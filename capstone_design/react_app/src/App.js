    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (inputMessage.includes("직업을 추천해")) {
                ...
                let response = await fetch('http://capstone.sung4854.com:5000/api/predict', {
                    method: 'POST',
                    headers: {
                ...
                if (jobList) { // 직업 추천을 받았다면
                    ...
                    if (jobIndex >= 0 && jobIndex < jobKeys.length) {
                        ...
                        response = await fetch(`http://capstone.sung4854.com:5000/api/get_job_detail/${jobInfo}`, {
                            method: 'GET',
                        });
                    } else {
                ...
                response = await fetch('http://capstone.sung4854.com:5000/api/chat', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
